...
const czechTranslationSet: TranslationSet = {
  ...
  ueliCommandEditSettingsFileDescription:
    "Upravte soubor nastavení pomocí svého výchozího textového editoru",
  ...
  ueliCommandRefreshIndexesDescription:
    "Aktualizuje všechny indexy všech pluginů",
  ...
  generalSettingsAutostartApp:
    "Automaticky sputit aplikace při startu počítače",
  ...
  generalSettingsRescanInterval:
    "Interval pravidelného skenování (v sekundách)",
  generalSettingsShowAlwaysOnPrimaryDisplay:
    "Vždy zobrazit na primární obrazovce",
  ...
  generalSettingsImportErrorInvalidConfig:
    "Import nastavení se nezdařil: Zdá se, že obsah souboru je neplatný",
  generalSettingsResetAllSettings: "Obnovit všechna nastavení",
  generalSettingsResetWarning:
    "Chystáte se obnovit všechna obecná nastavení na výchozí hodnoty. Chcete pokračovat?",
  generalSettingsResetAllSettingsWarning:
    "Chystáte se obnovit VŠECHNY nastavení na výchozí. Chcete pokračovat?",
  generalSettingsClearExecutionLogWarning:
    "Chystáte se vymazat protokol používání. Chcete pokračovat?",
  generalSettingsHideMainWindowAfterExecution:
    "Skrýt okno po provedení příkazu",
  ...
  generalSettingsErrorWhileCheckingForUpdate:
    "Při pokusu o kontrolu aktualizací došlo k chybě",
  ...
  appearanceSettingsMaxSearchResultsPerPage:
    "Maximální počet výsledků vyhledávání na stránku",
  appearanceSettingsSearchResultHeight:
    "Výška výsledku vyhledávání (v pixelech)",
  ...
  appearanceSettingsUserInputBottomMargin:
    "Vstup uživatele bottom margin (v pixelech)",
  appearanceSettingsSearchResultsBorderRadius:
    "Výsledky vyhledávání border radius",
  ...
  colorThemeSettingsResetWarning:
    "Chystáte se obnovit barevné scháma na výchozí. Chcete pokračovat?",
  ...
  applicationSearchSettingsUseNativeIcons:
    "Používat nativní ikony (vypnutí může vést k lepšímu výkonu)",
  ...
  shortcutSettingsEditModalCommandLinetoolDescription:
    "Upravit soubor in Visual Studio Code",
  ...
  translationSettingsMinSearchTermLength:
    "Minimální délka vyhledávacího dotazu",
  ...
  operatingSystemSettingsSettingsDescription:
    "Tento plugin umožňuje rychle najít nastavení operačního systému.",
  ...
  calculatorDescription:
    "Tento plugin vám umožňuje rychle provádět jednoduché výpočty.",
  calculatorPrecision: "Přesnost",

  openUrlWithBrowser: "Otevřete pomocí webového prohlížeče",
  url: "URL",
  urlDescription:
    "Tento plugin umožňuje rychle otevírat webové stránky zadáním adresy URL.",
  urlDefaultProtocol: "Výchozí protokol",

  email: "Email",
  emailSettingsDescription:
    "Tento plugin umožňuje rychle začít psát e-maily zadáním e-mailové adresy.",
  ...
  currencyConverterCopyToClipboard:
    "Stisknutím klávesy Enter zkopírujete do schránky",

  workflows: "Workflows",
  workflowSettingsDescription:
    "Tento plugin umožňuje rychle provádět více věcí najednou.",
  ...
  uwpSettingsDescription:
    "Tento plugin umožňuje najít předinstalované aplikace UWP.",

  colorConverter: "Převodník barev",
  colorConverterDescription:
    "Tento plugin umožňuje rychle převádět barvy do různých formátů.",
  ...
  controlPanelSettingsDescription:
    "Tento plugin umožňuje rychle najít položky ovládacího panelu."
};

export default czechTranslationSet;
