...
const portugueseTranslationSet: TranslationSet = {
  ...
  ueliCommandEditSettingsFileDescription:
    "Editar o arquivo de configuração com o editor padrão",
  ...
  ueliCommandRefreshIndexesDescription:
    "Atualizar os índices de todos os plugins",
  ...
  generalSettingsClearExecutionLogWarning:
    "Você tem certeza que deseja limpar o log de execução? Quer continuar?",
  generalSettingsHideMainWindowAfterExecution:
    "Esconder a janela de log de execução",
  ...
  generalSettingsCheckingForUpdate:
    "Verificando se a atualização está disponível",
  ...
  generalSettingsErrorWhileCheckingForUpdate:
    "Erro durante a tentativa de verificar a atualização",
  ...
  appearanceSettingsAllowTransparentBackground:
    "Habilitar o fundo transparente",
  ...
  appearanceSettingsUserInputBottomMargin:
    "Margem inferior do campo de pesquisa (em pixels)",
  ...
  colorThemeSearchResultsItemActiveBackgroundColor:
    "Cor do fundo do resultado selecionado",
  colorThemeSearchResultsItemActiveTextColor:
    "Cor do texto do resultado selecionado",
  colorThemeSearchResultsItemActiveDescriptionColor:
    "Cor da descrição do resultado selecionado",
  colorThemeSearchResutlsItemNameTextColor:
    "Cor do texto do nome dos resultados",
  colorThemeSearchResultsItemDescriptionTextColor:
    "Cor do texto da descrição dos resultados",
  ...
  applicationSearchSettingsAddApplicationFolder:
    "Adicionar pasta de aplicativo",
  applicationSearchSettingsApplicationFileExtensions:
    "Extenções de aplicativos",
  ...
  applicationSearchSettingsUseNativeIcons:
    "Usar ícones nativos (desligar pode resultar em uma performance melhor)",
  ...
  shortcutSettingsEditModalCommandLinetoolDescription:
    "Editar arquivo no Visual Studio Code",
  ...
  calculatorCopyToClipboard:
    "Pressione Enter para copiar para a área de transferência",
  calculatorDescription:
    "Este plugin te possibilita realizar cálculos simples rapidamente.",
  calculatorPrecision: "Precisão",

  openUrlWithBrowser: "Abrir com o navegador",
  url: "URL",
  urlDescription:
    "Este plugin te habilita a rapidamente abrir um site apenas digitando o URL.",
  ...
  workflowSettingsDescription:
    "Este plugin te habilita a executar múltiplas tarefas de uma vez.",
  ...
  commandlineSettingsDescription:
    "Este plugin te habilita a executar linhas de comando rapidamente.",
  commandlineShell: "Shell",

  simpleFolderSearch: "Pesquisa simples em pasta",
  simpleFolderSearchDescription:
    "Este plugin te habilita a pesquisar rapidamente por arquivos ou pastas",
  ...
  uwpSettingsDescription:
    "Este plugin te habilita a encontrar aplicativos UWP instalados.",

  colorConverter: "Converter cor",
  colorConverterDescription:
    "Este plugin te habilita a rapidamente converter cores em diferentes formatos.",
  ...
  browserBookmarksDescription:
    "Este plugin te habilita a procurar em seus favoritos de navegador.",
  ...
  controlPanelSettingsDescription:
    "Este plugin te habilita a rapidamente encontrar itens do painel de controle."
};

export default portugueseTranslationSet;
