...
const englishTranslationSet: TranslationSet = {
  trayIconShow: "Show",
  ...
  ueliCommandEditSettingsFileDescription:
    "Edit the settings file with your default text editor",
  ...
  generalSettingsImportErrorInvalidConfig:
    "Settings import failed: file content seems to be invalid",
  generalSettingsResetAllSettings: "Reset all settings to default",
  generalSettingsResetWarning:
    "You are about to reset all general settings to default. Do you want to proceed?",
  generalSettingsResetAllSettingsWarning:
    "You are about to reset ALL settings to default. Do you want to proceed?",
  generalSettingsClearExecutionLogWarning:
    "You are about to clear the execution log. Do you want to proceed?",
  ...
  generalSettingsErrorWhileCheckingForUpdate:
    "Error while trying to check for update",
  ...
  appearanceSettingsShowDescriptionOnAllSearchResults:
    "Show description on all search results",
  ...
  appearanceSettingsUserInputBottomMargin:
    "User input bottom margin (in pixels)",
  ...
  applicationSearchSettingsUseNativeIcons:
    "Use native icons (turned off might result to better performance)",
...
export default englishTranslationSet;
