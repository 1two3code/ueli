...
const germanTranslationSet: TranslationSet = {
  trayIconShow: "Öffnen",
  ...
  ueliCommandClearCachesDescription:
    "Löscht alle Zwischenspeicher von allen Plugins",
  ueliCommandEditSettingsFile: "Einstellungsdatei bearbeiten",
  ueliCommandEditSettingsFileDescription:
    "Bearbeite die Einstellungsdatei in deinem Standardtexteditor",
  ...
  ueliCommandRefreshIndexesDescription:
    "Alle Indexe von allen Plugins aktualisieren",
  ...
  generalSettingsShowAlwaysOnPrimaryDisplay:
    "Immer auf primärem Bildschirm anzeigen",
  ...
  generalSettingsSuccessfullyExportedSettings:
    "Erfolgreich Einstellungen exportiert",
  ...
  generalSettingsImportErrorInvalidConfig:
    "Einstellungsimport fehlgeschlagen: Dateiinhalt scheint ungültig zu sein",
  ...
  generalSettingsClearExecutionLogWarning:
    "Du bist dabei den Ausführungslog zu löschen. Willst du fortfahren?",
  generalSettingsHideMainWindowAfterExecution:
    "Fenster nach Ausführung verstecken",
  generalSettingsHideMainWindowOnBlur:
    "Fenster verstecken, wenn es den Fokus verliert",
  ...
  appearanceSettingsAllowTransparentBackground:
    "Transparenter Hintergrund erlauben",
  ...
  appearanceSettingsUserInputBottomMargin:
    "Benutzereingabe unterer Rand (in Pixel)",
  ...
  colorThemeSearchResultsItemActiveBackgroundColor:
    "Aktives Suchergebnis Hintergrundfarbe",
  ...
  applicationSearchSettingsAddApplicationFolder:
    "Programmverzeichnis hinzufügen",
  applicationSearchSettingsApplicationFileExtensions:
    "Programmdateierweiterung",
  ...
  applicationSearchSettingsUseNativeIcons:
    "Native Icons verwenden (deaktiviert führt evt. zu besserer Performance)",
  ...
  shortcutSettingsEditModalCommandLinetoolDescription:
    "Datei mit Visual Studio Code bearbeiten",
  shortcutSettingsNeedsUserConfirmation:
    "Braucht eine Bestätigung vor der Ausführung",
  ...
  calcuator: "Rechner",
  calculatorCopyToClipboard:
    "Drücke Enter um in die Zwischenablage zu kopieren",
  calculatorDescription:
    "Dieses Plugin erlaubt es dir schnell einfache Rechnungen zu machen.",
  calculatorPrecision: "Präzision",

  openUrlWithBrowser: "Im Webbrowser öffnen",
  url: "URL",
  urlDescription:
    "Dieses Plugin erlaubt es dir Webseiten schnell aufzurufen, indem du eine URL eingibst",
  ...
  workflowSettingsDescription:
    "Dieses Plugin erlaubt es dir schnell mehrere Dinge auf einmal auszuführen",
  ...
  workflowDescriptionPlaceholder:
    "Füge die Beschreibung deines Workflows hier ein",
  workflowTags: "Tags",
  workflowIcon: "Icon",
  ...
  workflowNeedsUserConfirmationBeforeExecution:
    "Braucht Bestätigung vor der Ausführung",

  commandline: "Kommandozeile",
  commandlinePrefix: "Präfix",
  commandlineSettingsDescription:
    "Dieses Plugin erlaubt es dir schnell Kommandozeilenbefehle auszuführen.",
  commandlineShell: "Shell",

  simpleFolderSearch: "Einfache Ordnersuche",
  simpleFolderSearchDescription:
    "Dieses Plugin erlaubt es dir, schnell Dateien und Ordner zu finden.",
  ...
  uwpSettingsDescription:
    "Dieses Plugin erlaubt es dir vorinstallierte UWP-Apps zu finden.",

  colorConverter: "Farbkonverter",
  colorConverterDescription:
    "Dieses Plugin erlaubt es dir Farben in verschiedene Formate zu konvertieren.",
  ...
  browserBookmarksDescription:
    "Dieses Plugin erlaubt es dir die Lesezeichen deines Browser zu durchsuchen.",
  ...
  controlPanelSettingsDescription:
    "Dieses Plugin erlaubt es dir, Elemente der Systemsteuerung schnell zu finden."
};
export default germanTranslationSet;
