...
} from "./everything-search-options";
...
} from "./color-theme-options";
import {
  FileBrowserOptions,
  defaultFileBrowserOptions
} from "./filebrowser-options";
import {
...
} from "./simple-folder-search-options";
import {
  UwpSearchOptions,
  defaultUwpSearchOptions
} from "./uwp-search-options";
import {
  ColorConverterOptions,
  defaultColorConverterOptions
} from "./color-converter-options";
import {
  ApplicationSearchOptions,
  defaultApplicationSearchOptions
} from "./application-search-options";
import {
...
import {
  ...
  defaultBrowserBookmarksOptions
} from "./browser-bookmarks-options";
import {
  ControlPanelOptions,
  defaultControlPanelOptions
} from "./control-panel-options";
