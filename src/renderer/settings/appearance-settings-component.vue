    ...
    <div class="settings__setting-content">
      <div class="box">
        <div class="settings__options-container">
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    step="1"
                    class="input"
                    v-model="config.appearanceOptions.userInputHeight"
                    @change="updateConfig"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsUserInputBorderRadius }}
            </div>
            <span
              class="icon tooltip is-tooltip-multiline"
              :data-tooltip="
                translations.appearanceSettingsBorderRadiusDescription
              "
            >
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="text"
                    class="input"
                    v-model="config.appearanceOptions.userInputBorderRadius"
                    @change="updateConfig"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsUserInputBottomMargin }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    step="1"
                    class="input"
                    v-model="config.appearanceOptions.userInputBottomMargin"
                    @change="updateConfig"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsShowSearchIcon }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="showSearchIconCheckbox"
                    type="checkbox"
                    name="showSearchIconCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.appearanceOptions.showSearchIcon"
                    @change="updateConfig"
                  />
      ...
      <div class="box">
        <div class="settings__options-container">
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    step="1"
                    class="input"
                    v-model="config.appearanceOptions.searchResultHeight"
                    @change="updateConfig"
                  />
                </div>
              </div>
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    step="1"
                    class="input"
                    v-model="config.appearanceOptions.maxSearchResultsPerPage"
                    @change="updateConfig"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsSearchResultsBorderRadius }}
            </div>
            <span
              class="icon tooltip is-tooltip-multiline"
              :data-tooltip="
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="text"
                    class="input"
                    v-model="config.appearanceOptions.searchResultsBorderRadius"
                    @change="updateConfig"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsScrollbarBorderRadius }}
            </div>
            <span
              class="icon tooltip is-tooltip-multiline"
              :data-tooltip="
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="text"
                    class="input"
                    v-model="config.appearanceOptions.scrollbarBorderRadius"
                    @change="updateConfig"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            ...
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="showDescriptionOnAllSearchResults"
                    type="checkbox"
                    name="showDescriptionOnAllSearchResults"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="
                      config.appearanceOptions.showDescriptionOnAllSearchResults
                    "
                    @change="updateConfig"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsShowSearchResultNumbers }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="showSearchResultNumbersCheckbox"
                    type="checkbox"
                    name="showSearchResultNumbersCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.appearanceOptions.showSearchResultNumbers"
                    @change="updateConfig"
                  />
      ...
      <div class="box">
        <div class="settings__options-container">
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    step="1"
                    class="input"
                    v-model="config.appearanceOptions.windowWidth"
                    @change="updateConfig"
                  />
                </div>
              </div>
              ...
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    ...
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.appearanceOptions.smoothScrolling"
                    @change="updateConfig"
                  />
          ...
          <div class="settings__option" v-if="isWindows">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsAllowTransparentBackground }}
              ({{ translations.restartRequired }})
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="allowTransparentBackgroundCheckbox"
                    type="checkbox"
                    name="allowTransparentBackgroundCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="
                      config.appearanceOptions.allowTransparentBackground
                    "
                    @change="updateConfig"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.appearanceSettingsFontFamily }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="text"
                    class="input"
                    v-model="config.appearanceOptions.fontFamily"
                    @change="updateConfig"
                  />
                </div>
              </div>
