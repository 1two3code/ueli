<template>
  <div class="settings-table__icon-container">
    <img
      v-if="getIcon(icon).type === iconTypeUrl"
      :src="getIcon(icon).parameter"
      class="settings-table__icon-url"
    />
    <div
      v-if="getIcon(icon).type === iconTypeSvg"
      v-html="getIcon(icon).parameter"
      class="settings-table__icon-svg"
    ></div>
    <div
      v-if="getIcon(icon).type === iconTypeColor"
      :style="getBackgroundColor(icon)"
      class="settings-table__icon-color"
    ></div>
  </div>
</template>
