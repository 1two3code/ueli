<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.translationOptions.enabled"
          :toggled="toggleEnabled"
        />
        <button
          v-if="config.translationOptions.enabled"
          class="button"
          @click="resetAll"
        >
    ...
    <p
      ...
      v-html="translations.translationSettingsDescription"
    ></p>
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <div class="select">
                    ...
                    >
                      <option
                        v-for="sourceLanguage in sourceLanguages"
                        v-bind:key="sourceLanguage"
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <div class="select">
                    ...
                    >
                      <option
                        v-for="targetLanguage in targetLanguages"
                        v-bind:key="targetLanguage"
