<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.websearchOptions.isEnabled"
          :toggled="toggleEnabled"
        />
        <button
          v-if="config.websearchOptions.isEnabled"
          class="button"
          @click="resetAll"
        >
    ...
    <p
      ...
      v-html="translations.websearchSettingDescription"
    ></p>
    <div class="settings__setting-content">
      ...
      <div class="settings__setting-content-item box">
        ...
        <div class="table-container">
          <table
            v-if="config.websearchOptions.webSearchEngines.length > 0"
          ...
          >
            ...
            <tbody>
              <tr
                v-for="(websearchEngine, index) in config.websearchOptions
                  .webSearchEngines"
                v-bind:key="index"
              >
                ...
                <td class="has-text-centered">
                  <icon
                    ...
                    :defaulticon="defaultWebSearchIcon"
                  ></icon>
                </td>
                <td class="has-text-centered">
                  {{ websearchEngine.priority }}
                </td>
                <td class="has-text-centered">
                  <i v-if="websearchEngine.isFallback" class="fas fa-check"></i>
                </td>
                <td class="has-text-centered">
                  <i
                    v-if="websearchEngine.encodeSearchTerm"
                    class="fas fa-check"
                  ></i>
                </td>
                <td class="has-text-centered">
                ...
                <td class="has-text-centered">
                  <button
                    ...
                    @click="removeWebsearchEngine(index)"
                  >
                    <span class="icon">
