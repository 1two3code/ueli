<template>
  <div v-if="visible" class="">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.everythingSearchOptions.enabled"
    ...
    <p
      ...
      v-html="translations.everythingSearchSettingDescription"
    ></p>
    <div class="settings__setting-content">
      <div
        v-if="!config.everythingSearchOptions.enabled"
          ...
          <div class="column field has-addons">
            <div class="control is-expanded">
              <input
                type="text"
                class="input"
                v-model="config.everythingSearchOptions.pathToEs"
              />
            </div>
            <div class="control">
          ...
          <div class="column field has-addons">
            <div class="control is-expanded">
              <input
                ...
                v-model="config.everythingSearchOptions.prefix"
              />
            </div>
            <div class="control">
              <button class="button is-success" @click="updateConfig">
          ...
          <div class="column field has-addons">
            <div class="control is-expanded">
              <input
                ...
                min="1"
                class="input"
                v-model="config.everythingSearchOptions.maxSearchResults"
              />
            </div>
            <div class="control">
              <button class="button is-success" @click="updateConfig">
