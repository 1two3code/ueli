<template>
  <div v-if="visible">
    ...
    <p
      ...
      v-html="translations.searchEngineSettingsDescription"
    ></p>
    <div class="settings__setting-content">
      <div class="box">
        <div class="settings__options-container">
          <div class="settings__option">
            <div class="settings__option-name">
              ...
              <span
                class="icon tooltip"
                :data-tooltip="
                  translations.searchEngineSettingsFuzzynessDescription
                "
              >
              ...
              <div class="field is-grouped is-grouped-right vertical-center">
                <div class="control">
                  <input
                    ...
                    max="1"
                    step="0.01"
                    v-model="config.searchEngineOptions.fuzzyness"
                    @change="updateConfig"
                  />
                </div>
                <div class="control">
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.searchEngineSettingsBlacklist }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <ul
                  v-if="config.searchEngineOptions.blackList.length > 0"
                  class="has-text-right"
                >
                  <li
                    v-for="(blackListEntry, index) in config.searchEngineOptions
                      .blackList"
