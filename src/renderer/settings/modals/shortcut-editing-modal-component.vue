    ...
    <div class="modal-content">
      <div class="message">
        ...
        <div class="message-body">
            ...
            <div class="control is-expanded">
              <div class="select is-fullwidth">
                <select v-model="shortcut.type" :autofocus="autofocus">
                  <option
                    v-for="shortcutType in shortcutTypes"
                    :value="shortcutType"
                  >
          ...
          <div class="field">
            ...
            <div class="control">
              <input
                class="input"
                type="text"
                :placeholder="getShorcutTypeNamePlaceholder(shortcut.type)"
          ...
          <div class="field">
            <label class="label">{{
              getShorcutTypeExecutionArgumentDescription(shortcut.type)
            }}</label>
          </div>
          <div
            class="field"
            :class="{ 'has-addons': shortcut.type === shortcutTypeFilePath }"
          >
            <div class="control is-expanded">
              <input
                class="input"
                type="text"
                :placeholder="
                  getShorcutTypeExecutionArgumentPlaceholder(shortcut.type)
                "
                v-model="shortcut.executionArgument"
              />
            </div>
          ...
          <div class="field">
            ...
            <div class="control">
              <input
                ...
                type="text"
                :placeholder="
                  getShorcutTypeDescriptionPlaceholder(shortcut.type)
                "
          ...
          <div class="field">
            ...
            <div class="control">
              <input
                ...
                v-model="shortcut.needsUserConfirmationBeforeExecution"
              />
          ...
          <tags-editing
            :tags="shortcut.tags"
            :field-title="translations.shortcutSettingsTableTags"
...
import {
  ...
  isValidMacOsFilePath
} from "../../../common/helpers/file-path-validators";
  ...
  methods: {
    saveButtonClick(): void {
      ...
      if (isValidShortcutToAdd(this.shortcut, filePathValidator)) {
        ...
        showNotification(
          translations.shortcutSettingsInvalidShortcutErrorMessage,
    ...
    getShorcutTypeDescriptionPlaceholder(shortcutType: ShortcutType): string {
      ...
      switch (shortcutType) {
        ...
        case ShortcutType.CommandlineTool:
          placeholder =
            translations.shortcutSettingsEditModalCommandLinetoolDescription;
          break;
        default:
          placeholder = "";
          break;
    ...
    getShorcutTypeExecutionArgumentDescription(
    ...
    getShorcutTypeExecutionArgumentPlaceholder(
      shortcutType: ShortcutType
    ): string {
      const { translations }: { translations: TranslationSet } = this;
      let placeholder = "";
