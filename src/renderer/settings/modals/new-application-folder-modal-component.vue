      ...
      <div class="message">
        ...
        <div class="message-body">
          ...
          <div class="field is-grouped is-grouped-right">
            ...
            <div class="control">
              <button
                :disabled="newApplicationFolder.length === 0"
...
export default Vue.extend({
  ...
  methods: {
    ...
    saveButtonClick() {
      const validator: (filePath: string) => Promise<void> = this
        .validateFolderPath;
  ...
  mounted() {
    vueEventDispatcher.$on(
      VueEventChannels.openNewApplicationFolderModal,
      () => {
        this.visible = true;
      }
    );
