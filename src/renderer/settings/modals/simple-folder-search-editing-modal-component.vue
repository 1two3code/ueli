        ...
        <div class="message-body">
          ...
          <div class="field has-addons">
            <div class="control is-expanded">
              <input
                class="input"
                type="text"
                v-model="options.folderPath"
                :placeholder="getFolderPathPlaceholder()"
              />
            </div>
            <div class="control">
          ...
          <div class="field">
            ...
            <div class="control is-expanded">
              <input
                class="is-checkradio"
                id="excludeHiddenFilexCheckbox"
                type="checkbox"
                name="excludeHiddenFilexCheckbox"
                v-model="options.excludeHiddenFiles"
              />
...
export default Vue.extend({
  ...
  mounted() {
    vueEventDispatcher.$on(
      ...
      (
        folderOptions?: SimpleFolderSearchOptions,
