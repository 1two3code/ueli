<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.fileBrowserOptions.isEnabled"
    ...
    <p
      ...
      v-html="translations.fileBrowserSettingsDescription"
    ></p>
    <div class="settings__setting-content">
      <div
        v-if="!config.fileBrowserOptions.isEnabled"
        class="settings__setting-disabled-overlay"
      ></div>
      <div class="box">
        <div class="settings__option">
          <div class="settings__option-name">
            {{ translations.fileBrowserSettingsMaxSearchResults }}
          </div>
            ...
            <div class="field is-grouped is-grouped-right">
              <div class="control">
                <input
                  ...
                  type="number"
                  min="10"
                  v-model="config.fileBrowserOptions.maxSearchResults"
                  @change="updateConfig"
                />
              </div>
            </div>
        ...
        <div class="settings__option">
          <div class="settings__option-name">
            {{ translations.fileBrowserOptionsShowHiddenFiles }}
          </div>
          <div class="settings__option-content">
            <div class="field has-addons has-addons-right vertical-center">
              <div class="control">
                <input
                  id="showHiddenFilesCheckbox"
                  type="checkbox"
                  name="showHiddenFilesCheckbox"
                  class="switch is-rounded is-success"
                  checked="checked"
                  v-model="config.fileBrowserOptions.showHiddenFiles"
                  @change="updateConfig"
                />
        ...
        <div class="settings__option">
          <div class="settings__option-name">
            {{ translations.fileBrowserOptionsBlackList }}
          </div>
          <div class="settings__option-content">
            <div class="field is-grouped is-grouped-right">
              <ul
                v-if="config.fileBrowserOptions.blackList.length > 0"
                class="has-text-right"
              >
                <li
                  v-for="(blackListEntry, index) in config.fileBrowserOptions
                    .blackList"
                  v-bind:key="blackListEntry"
                >
                  <span class="tag">
                    {{ blackListEntry }}
                    <button
                      class="delete is-small"
                      @click="removeBlackListEntry(index)"
                    ></button>
                  </span>
                </li>
              </ul>
            ...
            <div class="field has-addons has-addons-right">
              <div class="control">
                <input
                  ...
                  :placeholder="
                    translations.fileBrowserOptionsBlackListPlaceholder
                  "
                />
              </div>
              <div class="control">
            ...
            <div class="field has-addons has-addons-right vertical-center">
              <div class="control">
                <input
                  ...
                  class="switch is-rounded is-success"
                  checked="checked"
                  v-model="config.fileBrowserOptions.showFullFilePath"
                  @change="updateConfig"
                />
...
export default Vue.extend({
  ...
  methods: {
    ...
    toggleEnabled() {
      const { config }: { config: UserConfigOptions } = this;
      config.fileBrowserOptions.isEnabled = !config.fileBrowserOptions
        .isEnabled;
      this.updateConfig();
    },
    addBlackListEntry() {
      const { newBlackListEntry } = this;
