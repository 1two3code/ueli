<template>
  <div v-if="isVisible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.dictionaryOptions.isEnabled"
    ...
    <p
      ...
      v-html="translations.dictionaryDescription"
    ></p>
    <div class="settings__setting-content">
      <div
        v-if="!config.dictionaryOptions.isEnabled"
        ...
        <div class="settings__option-container">
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.dictionaryDebounceDelay }}
            </div>
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="number"
                    class="input"
                    v-model="config.dictionaryOptions.debounceDelay"
                    @change="updateConfig()"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.dictionaryMinSearchTermLength }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="number"
                    class="input"
                    v-model="config.dictionaryOptions.minSearchTermLength"
                    @change="updateConfig()"
                  />
                </div>
              </div>
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    type="input"
                    class="input"
                    v-model="config.dictionaryOptions.prefix"
                    @change="updateConfig()"
                  />
                </div>
              </div>
