<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.commandlineOptions.isEnabled"
    ...
    <p
      ...
      v-html="translations.commandlineSettingsDescription"
    ></p>
    <div class="settings__setting-content">
      <div
        v-if="!config.commandlineOptions.isEnabled"
        ...
        <div class="settings__options-container">
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.commandlinePrefix }}
            </div>
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    v-model="config.commandlineOptions.prefix"
                    @change="updateConfig"
                  />
                </div>
              </div>
            ...
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <div class="select">
                    <select
                      v-model="config.commandlineOptions.shell"
                      @change="updateConfig"
                    >
                      <option
                        v-for="availableShell in availableShells"
                        v-bind:key="availableShell"
                        >{{ availableShell }}</option
                      >
                    </select>
                  </div>
                </div>
...
import {
  WindowsShell,
  MacOsShell
} from "../../main/plugins/commandline-plugin/shells";
...
export default Vue.extend({
  ...
  methods: {
    ...
    toggleEnabled() {
      const { config }: { config: UserConfigOptions } = this;
      config.commandlineOptions.isEnabled = !config.commandlineOptions
        .isEnabled;
      this.updateConfig();
    },
    updateConfig() {
