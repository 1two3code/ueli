  ...
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        ...
        <div
          class="dropdown is-right"
          :class="{ 'is-active': presetDropdownVisible }"
        >
          <div class="dropdown-trigger">
            <button
              class="button"
            ...
            <div class="field has-addons has-addons-right">
              <div class="control">
                <button
                  class="button preview-button"
                  :style="
                    getPreviewColor(config.colorThemeOptions.userInputTextColor)
                  "
                  @click="
                    editColor(
                      'userInputTextColor',
    ...
    <div class="box">
      <div class="settings__options-container">
          ...
          <div class="settings__option-content">
            <div class="field has-addons has-addons-right">
              ...
              <div class="control">
                <button
                  class="button"
                  @click="resetSearchResultsBackgroundColor"
                >
                  <span class="icon">
                    <i class="fas fa-undo-alt"></i>
                  </span>
          ...
          <div class="settings__option-content">
            <div class="field has-addons has-addons-right">
                  ...
                  :style="
                    getPreviewColor(
                      config.colorThemeOptions
                        .searchResultsItemActiveBackgroundColor
                    )
                  "
                  @click="
                    editColor(
              ...
              <div class="control">
                <button
                  class="button"
                  @click="resetSearchResultsItemActiveBackgroundColor"
                >
                  <span class="icon">
                    <i class="fas fa-undo-alt"></i>
                  </span>
            ...
            <div class="field has-addons has-addons-right">
              <div class="control">
                <button
                  ...
                  @click="
                    editColor(
                      'searchResultsItemActiveTextColor',
                      config.colorThemeOptions.searchResultsItemActiveTextColor
                    )
                  "
                ></button>
              ...
              <div class="control">
                <button
                  class="button"
                  @click="resetSearchResultsItemActiveTextColor"
                >
                  <span class="icon">
                    <i class="fas fa-undo-alt"></i>
                  </span>
        ...
        <div class="settings__option">
          <div class="settings__option-name">
            {{ translations.colorThemeSearchResultsItemActiveDescriptionColor }}
          </div>
          <div class="settings__option-content">
            <div class="field has-addons has-addons-right">
              <div class="control">
                <button
                  ...
                  :style="
                    getPreviewColor(
                      config.colorThemeOptions
                        .searchResultsItemActiveDescriptionColor
                    )
                  "
                  @click="
                    editColor(
              ...
              <div class="control">
                <button
                  class="button"
                  @click="resetSearchResultsItemActiveDescriptionColor"
                >
                  <span class="icon">
                    <i class="fas fa-undo-alt"></i>
                  </span>
          ...
          <div class="settings__option-content">
            <div class="field has-addons has-addons-right">
              ...
              <div class="control">
                <button
                  class="button"
                  @click="resetSearchResultsItemNameTextColor"
                >
                  <span class="icon">
                    <i class="fas fa-undo-alt"></i>
                  </span>
          ...
          <div class="settings__option-content">
            <div class="field has-addons has-addons-right">
              <div class="control">
                <button
                  ...
                  :style="
                    getPreviewColor(
                      config.colorThemeOptions
                        .searchResultsItemDescriptionTextColor
                    )
                  "
                  @click="
                    editColor(
              ...
              <div class="control">
                <button
                  class="button"
                  @click="resetSearchResultsItemDescriptionTextColor"
                >
                  <span class="icon">
                    <i class="fas fa-undo-alt"></i>
                  </span>
...
export default Vue.extend({
          ...
          if (filePath) {
            FileHelpers.readFile(filePath)
              .then((fileContent: string) => {
                const colorThemeOptions = JSON.parse(
                  fileContent
  ...
  mounted() {
    ...
    vueEventDispatcher.$on(
      VueEventChannels.saveColor,
      (pickerId: string, color: string) => {
