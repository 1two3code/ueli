<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.calculatorOptions.isEnabled"
          :toggled="toggleEnabled"
        />
        <button
          v-if="config.calculatorOptions.isEnabled"
          class="button"
          @click="resetAll"
        >
    ...
    <p
      ...
      v-html="translations.calculatorDescription"
    ></p>
        ...
        <div class="settings__option-container">
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.calculatorPrecision }}
            </div>
          ...
          <div>
            {{ translations.example }}: sum(1{{
              config.generalOptions.decimalSeparator
            }}2{{ argumentSeparator }} 3) = 4{{
              config.generalOptions.decimalSeparator
            }}2
          </div>
        </div>
