<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.colorConverterOptions.isEnabled"
    ...
    <p
      ...
      v-html="translations.colorConverterDescription"
    ></p>
    <div class="settings__setting-content">
      <div
        v-if="!config.colorConverterOptions.isEnabled"
        ...
        <div class="settings__option-container">
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.colorConverterShowColorPreview }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    id="colorPreviewToggle"
                    type="checkbox"
                    name="colorPreviewToggle"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.colorConverterOptions.showColorPreview"
                    @change="updateConfig()"
                  />
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.colorConverterOptions.hexEnabled"
                    @change="updateConfig()"
                  />
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.colorConverterOptions.rgbEnabled"
                    @change="updateConfig()"
                  />
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.colorConverterOptions.rgbaEnabled"
                    @change="updateConfig()"
                  />
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.colorConverterOptions.hslEnabled"
                    @change="updateConfig()"
                  />
...
export default Vue.extend({
  ...
  methods: {
    toggleEnabled() {
      ...
      config.colorConverterOptions.isEnabled = !config.colorConverterOptions
        .isEnabled;
      this.updateConfig();
    },
    resetAll() {
