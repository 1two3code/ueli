<template>
  <div v-if="visible">
    <div class="settings__setting-title title is-3">
      ...
      <div>
        <plugin-toggle
          :is-enabled="config.currencyConverterOptions.isEnabled"
          :toggled="toggleEnabled"
        />
        <button
          v-if="config.currencyConverterOptions.isEnabled"
          class="button"
          @click="resetAll"
        >
    ...
    <p
      ...
      v-html="translations.currencyConverterDescription"
    ></p>
        ...
        <div class="settings__option-container">
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.currencyConverterPrecision }}
            </div>
