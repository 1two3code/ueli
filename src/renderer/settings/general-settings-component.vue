    ...
    <div class="settings__setting-content">
      <div class="box">
        <div class="settings__options-container">
              ...
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    ...
                    type="checkbox"
                    name="showTrayIconCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.showTrayIcon"
                    @change="updateConfig()"
                  />
          ...
          <div class="settings__option">
            ...
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="clearCachesOnExit"
                    type="checkbox"
                    name="clearCachesOnExit"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.clearCachesOnExit"
                    @change="updateConfig()"
                  />
            ...
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right">
                <div class="control">
                  <div class="select">
                    <select
                      v-model="config.generalOptions.hotKey.modifier"
                      @change="updateConfig()"
                    >
                      <option
                ...
                <div class="control">
                  <div class="select">
                    <select
                      v-model="config.generalOptions.hotKey.key"
                      @change="updateConfig()"
                    >
                      <option
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.generalSettingsRescanIntervalEnabled }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    id="rescanEnabledCheckbox"
                    type="checkbox"
                    name="rescanEnabledCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.rescanEnabled"
                    @change="updateConfig()"
                  />
          ...
          <div
            ...
            v-if="config.generalOptions.rescanEnabled"
          >
            <div class="settings__option-name">
              ...
              <div class="field is-grouped is-grouped-right">
                <div class="control">
                  <input
                    ...
                    type="number"
                    min="10"
                    v-model="config.generalOptions.rescanIntervalInSeconds"
                    @change="updateConfig()"
                  />
                </div>
              </div>
          ...
          <div class="settings__option">
            ...
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="allowWindowMoveToggle"
                    type="checkbox"
                    name="allowWindowMoveToggle"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.allowWindowMove"
                    @change="updateConfig()"
                  />
          ...
          <div
            class="settings__option"
            v-if="config.generalOptions.allowWindowMove"
          >
            <div class="settings__option-name">
              {{ translations.generalSettingsRememberWindowPosition }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="rememberWindowPositionCheckbox"
                    type="checkbox"
                    name="rememberWindowPositionCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.rememberWindowPosition"
                    @change="updateConfig()"
                  />
          ...
          <div
            class="settings__option"
            v-if="!config.generalOptions.rememberWindowPosition"
          >
            <div class="settings__option-name">
            ...
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="showAlwaysOnPrimaryDisplayCheckbox"
                    type="checkbox"
                    name="showAlwaysOnPrimaryDisplayCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.showAlwaysOnPrimaryDisplay"
                    @change="updateConfig()"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.generalSettingsLogExecution }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="logExecutionCheckbox"
                    type="checkbox"
                    name="logExecutionCheckbox"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.logExecution"
                    @change="updateConfig()"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.generalSettingsPersistentUserInput }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="persistentUserInput"
                    type="checkbox"
                    name="persistentUserInput"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.persistentUserInput"
                    @change="updateConfig()"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.generalSettingsHideMainWindowAfterExecution }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="hideMainWindowAfterExecution"
                    type="checkbox"
                    name="hideMainWindowAfterExecution"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.hideMainWindowAfterExecution"
                    @change="updateConfig()"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.generalSettingsHideMainWindowOnBlur }}
            </div>
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  <input
                    id="hideMainWindowOnBlur"
                    type="checkbox"
                    name="hideMainWindowOnBlur"
                    class="switch is-rounded is-success"
                    checked="checked"
                    v-model="config.generalOptions.hideMainWindowOnBlur"
                    @change="updateConfig()"
                  />
          ...
          <div class="settings__option">
            <div class="settings__option-name">
              {{ translations.generalSettingsDecimalSeparator }}
            </div>
            <div class="settings__option-content">
              <div class="field is-grouped is-grouped-right">
                <div class="buttons has-addons">
                  <button
                    ...
                    :class="{
                      'is-success':
                        config.generalOptions.decimalSeparator == '.'
                    }"
                    @click="
                      config.generalOptions.decimalSeparator = '.';
                      updateConfig();
            ...
            <div class="settings__option-content">
              <div class="field has-addons has-addons-right vertical-center">
                <div class="control">
                  ...
                  <button
                    class="button"
                    v-if="updateStatus.latestVersionRunning"
                    disabled
                  >
                  ...
                  <button
                    class="button"
                    v-if="updateStatus.errorOnUpdateCheck"
                    disabled
                  >
                    {{
...
export default Vue.extend({
  data() {
    return {
      ...
      globalHotKeyModifiers: Object.values(GlobalHotKeyModifier).map(
        modifier => modifier
      ),
