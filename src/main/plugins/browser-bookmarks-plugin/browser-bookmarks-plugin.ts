...
export default class BrowserBookmarksPlugin implements SearchPlugin {
  ...
  public getAll(): Promise<SearchResultItem[]> {
    return new Promise(resolve => {
      resolve(
        this.browserBookmarks.map(bookmark =>
          this.buildSearchResultItem(bookmark)
        )
      );
    });
  }
  ...
  public updateConfig(
    ...
    return new Promise((resolve, reject) => {
      ...
      const browserChanged =
        updatedConfig.browserBookmarksOptions.browser !== this.config.browser;
