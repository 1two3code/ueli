...
const windowsSettings: WindowsSetting[] = [
  ...
  { URI: "ms-settings:sync", name: "Sync your settings" },
  {
    ...
    name: "Windows Hello setup (Face)"
  },
  {
    URI: "ms-settings:signinoptions-launchfingerprintenrollment",
    name: "Windows Hello setup (Finger)"
  },
  ...
  // cortana
  {
    URI: "ms-settings:cortana-notifications",
    name: "Cortana across my devices"
  },
  ...
  {
    URI: "ms-settings:easeofaccess-cursorandpointersize",
    name: "Cursor & pointer size"
  },
  ...
  {
    URI: "ms-settings:personalization-start-places",
    name: "Choose which folders appear on Start"
  },
  ...
  {
    URI: "ms-settings:surfacehub-devicemanagenent",
    name: "Team device management"
  },
  ...
  {
    URI: "ms-settings:quietmomentspresentation",
    name: "Duplicating my display"
  },
  ...
  },
  {
    ...
    name: "Windows Update-Restart options"
  },
  {
    URI: "ms-settings:windowsupdate-history",
    name: "Windows Update-View update history"
  },

  // user accounts
  {
    URI:
      "ms-settings:windowsanywhere (device must be Windows Anywhere-capable)",
    name: "Windows Anywhere"
  }
];

export default class WindowsOperatingSystemSettingRepository
  implements OperatingSystemSettingRepository {
      ...
      const result = windowsSettings.map(
        (windowsSetting): OperatingSystemSetting => {
          return {
            ...
            icon: {
              parameter: defaultWindowsOperatingSystemSettingIcon,
              type: IconType.URL
            },
