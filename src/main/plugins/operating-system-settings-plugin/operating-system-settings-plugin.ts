...
export default class OperatingSystemSettingsPlugin implements SearchPlugin {
  ...
  private readonly operatingSystemSettingExecutor: (
          ...
          const result = operatingSystemSettings.map(
            (operatingSystemSetting): SearchResultItem => {
              return {
                ...
                searchable: [
                  operatingSystemSetting.name,
                  ...operatingSystemSetting.tags
                ]
              };
            }
          );
  ...
  public execute(
    ...
    return this.operatingSystemSettingExecutor(
