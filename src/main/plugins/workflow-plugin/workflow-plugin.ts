...
export default class WorkflowPlugin implements SearchPlugin {
        ...
        (workflow): SearchResultItem => {
          return {
            ...
            needsUserConfirmationBeforeExecution:
              workflow.needsUserConfirmationBeforeExecution,
  ...
  public execute(
    ...
    return new Promise((resolve, reject) => {
      ...
      ).executionSteps.map(executionArgument =>
        this.handleExecutionStep(executionArgument)
      );
  ...
  private handleExecutionStep(
    ...
    switch (executionStep.executionArgumentType) {
      ...
      default:
        throw new Error(
          `Not a valud execitionArgumentType ${executionStep.executionArgumentType}`
        );
    }
  }
}
